...
# -*- coding: CP1252 -*-
#
# generated by wxGlade 0.6.7 (standalone edition) on Tue Nov 19 15:28:07 2013
#
...
class Principal(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_3 = wx.StaticText(self, wx.ID_ANY, _(u"Datos Academicos"))
        self.label_4 = wx.StaticText(self, wx.ID_ANY, _("Nombres:"))
        self.txtNombre = wx.TextCtrl(self, wx.ID_ANY, "")
        self.label_9 = wx.StaticText(self, wx.ID_ANY, _(u"Seccion:"))
        ...
        self.label_6 = wx.StaticText(self, wx.ID_ANY, _(u"Cedula:"))
        ...
        self.label_8 = wx.StaticText(self, wx.ID_ANY, _(u"Direccion:"))
        ...
        # Adjunta el validador a los controles de texto
        # invocando el método SetValidator(validador)
        self.txtCedula.SetValidator(ContieneDatos())
        self.__do_layout()
