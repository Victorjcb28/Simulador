...
# -*- coding: CP1252 -*-
#
# generated by wxGlade 0.6.7 (standalone edition) on Fri Jun 21 21:05:02 2013
#
...
class Principal(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.principal = wx.MenuItem(wxglade_tmp_menu, wx.ID_ANY, _("Principal"), "", wx.ITEM_NORMAL)
    ...
    def __set_properties(self):
        ...
        self.SetTitle(_("Tiro Horizontal"))
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        grid_sizer_1.Add(self.txtposinicial, 0, wx.EXPAND, 0)
    ...
    def OnSimulador(self, event):  # wxGlade: Principal.<event_handler>
        ...
        if vel <0:
            dlg=wx.MessageDialog(self,'La Velocidad No puede ser menor a 0', 'Atencion', wx.OK)
            dlg.ShowModal()
            dlg.Destroy()
        else:
            f.horizontal(self)
    ...
    def OnLetras(self, event):  # wxGlade: Principal.<event_handler>
        vel=self.txtvel.GetValue()
        Pos=self.txtposinicial.GetValue()
        
        if vel.isdigit()or Pos.isdigit():
                pass
        else:
