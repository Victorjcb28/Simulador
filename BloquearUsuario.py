...
# -*- coding: CP1252 -*-
#
# generated by wxGlade 0.6.7 (standalone edition) on Sat Dec 07 21:35:29 2013
#
...
class Principal(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.registro = wx.Menu()
        self.buscar = wx.MenuItem(self.registro, wx.ID_ANY, _("Buscar"), "", wx.ITEM_NORMAL)
        self.registro.AppendItem(self.buscar)
        self.frame_1_menubar.Append(self.registro, _("Registro"))
        self.SetMenuBar(self.frame_1_menubar)
        # Menu Bar end
        self.label_1 = wx.StaticText(self, wx.ID_ANY, _("Bloquear Usuario"))
        self.bitmap_1 = wx.StaticBitmap(self, wx.ID_ANY, wx.Bitmap("Inicio_sesion.gif", wx.BITMAP_TYPE_ANY))
        ...
        self.bitmap_2 = wx.StaticBitmap(self, wx.ID_ANY, wx.Bitmap("9152064-boton-de-nombre-de-usuario-y-contrasena-ademas-de-inicio-de-sesion-en-un-candado-para-acceso-seguro-.jpg", wx.BITMAP_TYPE_ANY))
        self.label_4 = wx.StaticText(self, wx.ID_ANY, _("Clave"))
        self.txtClave = wx.TextCtrl(self, wx.ID_ANY, "")
        self.bitmap_3 = wx.StaticBitmap(self, wx.ID_ANY, wx.Bitmap("iconos\\nuevo.png", wx.BITMAP_TYPE_ANY))
