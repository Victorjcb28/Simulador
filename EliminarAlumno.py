...
# -*- coding: CP1252 -*-
#
# generated by wxGlade 0.6.7 (standalone edition) on Sat Jan 11 19:12:19 2014
#
...
class Principal(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_1 = wx.StaticText(self, wx.ID_ANY, _("Eliminar Alumnos"))
        ...
        self.cobSeccion = wx.ComboBox(self, wx.ID_ANY, choices=[], style=wx.CB_DROPDOWN)
        ...
        self.cobCarrera = wx.ComboBox(self, wx.ID_ANY, choices=[], style=wx.CB_DROPDOWN)
        self.label_6 = wx.StaticText(self, wx.ID_ANY, _(u"Cédula:"))
        self.txtCedula = wx.TextCtrl(self, wx.ID_ANY, "")
        self.bitmap_button_1 = wx.BitmapButton(self, wx.ID_ANY, wx.Bitmap("buscar.png", wx.BITMAP_TYPE_ANY))
        self.label_7 = wx.StaticText(self, wx.ID_ANY, _("Sexo:"))
        self.cobSexo = wx.ComboBox(self, wx.ID_ANY, choices=[_("Masculino"), _("Femenino")], style=wx.CB_DROPDOWN)
        self.label_8 = wx.StaticText(self, wx.ID_ANY, _("Estado:"))
        ...
        self.label_8_copy = wx.StaticText(self, wx.ID_ANY, _(u"Dirección:"))
    ...
    def __set_properties(self):
        ...
        self.SetTitle(_("Eliminar Alumnos"))
        self.SetSize((604, 390))
        ...
        self.cobSeccion.Enable(False)
        self.txtApellido.Enable(False)
        self.cobCarrera.Enable(False)
        ...
        self.cobDireccion.Enable(False)
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        grid_sizer_1.Add((20, 20), 0, 0, 0)
        grid_sizer_1.Add((20, 20), 0, 0, 0)
        grid_sizer_1.Add(self.label_8_copy, 0, 0, 0)
    ...
    def OnBuscar(self, event):  # wxGlade: Principal.<event_handler>
        ...
        #self.cobSeccion.Enable(True)
        #self.txtApellido.Enable(True)
        #self.cobCarrera.Enable(True)
    ...
    def OnEliminar(self, event):  # wxGlade: Principal.<event_handler>
        ...
        #if self.Validate():
        #    dlg = wx.MessageDialog(None, '¿Desea Eliminar?',
         #                  'Dialogo de Mensage', wx.OK|wx.CANCEL|
          #                  wx.ICON_QUESTION)
            #dlg.ShowModal()
