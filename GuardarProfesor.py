...
# -*- coding: CP1252 -*-
#
# generated by wxGlade 0.6.7 (standalone edition) on Sun Oct 13 19:59:37 2013
#
...
class Principal(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        # Tool Bar
        self.vntPpal_BarraHerram = wx.ToolBar(self, -1)
        self.SetToolBar(self.vntPpal_BarraHerram)
        self.vntPpal_BarraHerram.AddLabelTool(1, _("Salir"), wx.Bitmap("iconos\\salir.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, _("Salir"), _("Salir"))
        self.vntPpal_BarraHerram.AddSeparator()
        self.vntPpal_BarraHerram.AddLabelTool(wx.ID_ANY, _("Guardar"), wx.Bitmap("iconos\\guardar.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, _("Guardar"), _("Guardar"))
        # Tool Bar end
        self.label_1 = wx.StaticText(self, wx.ID_ANY, _("Guardar Profesor"))
        self.label_2_copy = wx.StaticText(self, wx.ID_ANY, _("Datos Personales"))
        ...
        self.Bind(wx.EVT_TOOL, self.OnPrincipal, id=1)
        self.Bind(wx.EVT_TEXT, self.OnEstado, self.cobEstado)
        self.Bind(wx.EVT_TEXT_ENTER, self.Ontext, self.cobParroquia)
        self.Bind(wx.EVT_BUTTON, self.OnGuardar, self.button_1)
        # end wxGlade

    def __set_properties(self):
        # begin wxGlade: Principal.__set_properties
        self.SetTitle(_("Guardar Profesor"))
        self.SetSize((402,400))
        ...
        self.vntPpal_BarraHerram.Realize()
    ...
    def __do_layout(self):
        ...
        grid_sizer_1.Add((20, 20), 0, 0, 0)
        grid_sizer_1.Add(self.label_2_copy, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
        grid_sizer_1.Add((20, 20), 0, 0, 0)
        grid_sizer_1.Add((20, 20), 0, 0, 0)
    ...
    def OnCam(self, event):  # wxGlade: Principal.<event_handler>
    ...
    def Ontext(self, event):  # wxGlade: Principal.<event_handler>
